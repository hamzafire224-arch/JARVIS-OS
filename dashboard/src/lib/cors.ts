 ...
 *
 * SECURITY: localhost origins are ONLY included in development mode.
 * In production, only explicitly configured origins are allowed.
 */
const PRODUCTION_ORIGINS = 'https://app.letjarvis.com,https://jarvis-os-ebon.vercel.app';
const DEV_ORIGINS = 'https://app.letjarvis.com,http://localhost:3000,http://localhost:3001';

const ALLOWED_ORIGINS = (
    process.env.ALLOWED_ORIGINS ??
    (process.env.NODE_ENV === 'production' ? PRODUCTION_ORIGINS : DEV_ORIGINS)
