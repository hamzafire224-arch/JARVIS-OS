    ...
    <section className="snap-section bg-surface relative">
      ...
      <div className="relative z-10 flex flex-col items-center gap-10 px-6">
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-text-secondary text-center max-w-lg"
        >
        ...
        <motion.div
          ...
          className="mt-2 bg-white/[0.03] backdrop-blur-md border border-white/[0.08] rounded-2xl px-6 py-4 flex items-center gap-3 max-w-md w-full"
        >
