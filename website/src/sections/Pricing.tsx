const plans = [
  {
    ...
    cta: 'Download Free',
    ctaHref: 'https://app.letjarvis.com/signup',
    highlight: false,
  },
  {
    name: 'Productivity',
    price: 'Free',
    priceSub: '60-Day Full Access',
    description: 'Full power. All 25+ tools, cloud AI, 4-layer memory. Everything unlocked — free for 60 days.',
    badge: 'RECOMMENDED',
    features: [
    ...
    ctaHref: 'https://app.letjarvis.com/signup?plan=productivity',
    highlight: true,
  },
]
