      ...
      <main className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 min-h-screen flex items-center justify-center">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="hero-anim flex flex-col sm:flex-row items-center justify-center gap-6">
            <a href="https://jarvis-os-1mna.vercel.app/dashboard" className="bg-[#00F0FF] hover:bg-[#00d0dd] text-black px-8 py-4 rounded-full font-bold text-lg transition-all shadow-[0_0_30px_rgba(0,240,255,0.4)]">
              Launch Console
            </a>
